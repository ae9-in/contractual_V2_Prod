...
export const CATEGORY_PHOTOS: Record<string, string> = {
  ...
  Video: "1536240478227-65fcbc78b2e8",
  ...
  "Data & Analytics": "1551288049-bebda4e38f71",
}
...
const GIG_SEEDS: Omit<GigCardData, "id" | "image" | "gradient">[] = [
  ...
  {
    title: "I will produce short-form video ads for paid social",
  ...
  {
    title: "I will build a headless CMS with Next.js and GraphQL",
    category: "Development",
    freelancerId: "5",
    freelancer: { name: "David Kim", avatar: avatarUrl(4) },
    rating: 4.8,
  ...
  {
    title: "I will run technical SEO audits with prioritized fixes",
    category: "SEO",
    freelancerId: "8",
    freelancer: { name: "Nina Patel", avatar: avatarUrl(1), isPro: true },
    rating: 4.9,
  ...
  {
    title: "I will design pitch decks for investor meetings",
    category: "Design",
    freelancerId: "1",
    freelancer: { name: "Sarah Chen", avatar: avatarUrl(0), isPro: true },
    rating: 4.92,
  ...
  {
    title: "I will implement Stripe subscriptions and invoicing",
    category: "Development",
    freelancerId: "2",
    freelancer: { name: "Alex Rivera", avatar: avatarUrl(1), isPro: true },
    rating: 5.0,
  ...
  {
    title: "I will craft email sequences that lift trial-to-paid",
    category: "Marketing",
    freelancerId: "6",
    freelancer: { name: "Lisa Johnson", avatar: avatarUrl(5), isPro: true },
    rating: 4.88,
  ...
  {
    title: "I will document APIs and developer onboarding portals",
    category: "Writing",
    freelancerId: "3",
    freelancer: { name: "Emma Wilson", avatar: avatarUrl(2) },
    rating: 4.75,
  ...
  {
    title: "I will deliver executive dashboards in Looker or Tableau",
    category: "Data & Analytics",
    freelancerId: "11",
    freelancer: { name: "Chris Wong", avatar: avatarUrl(4) },
    rating: 4.7,

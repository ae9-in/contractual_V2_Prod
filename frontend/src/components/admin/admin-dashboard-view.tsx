...
async function fetchStats(): Promise<AdminStats> {
  ...
  return j.data as AdminStats
}

export function AdminDashboardView({ initialData }: { initialData?: AdminStats }) {
  const q = useQuery({ queryKey: ["workspace-admin-stats"], queryFn: fetchStats, initialData })

...
export function FreelancerOverview() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div
        className={cn(CARD, "relative overflow-hidden p-6 md:p-8")}
        style={{ borderColor: BORDER }}
      >
        ...
        <div className="relative flex flex-col md:flex-row justify-between gap-6">
          <div className="space-y-2">
            <div className="flex items-center gap-2 mb-1">
              <span className="text-[10px] font-black uppercase tracking-[0.2em] text-teal-600/70 bg-teal-50 px-2 py-0.5 rounded-md">
                Freelancer Console
              </span>
            ...
            <div className="flex items-center gap-3 text-[13px] font-medium text-[#64748b]">
              ...
              <div className="flex items-center gap-1.5">
                ...
                <span>{lastUpdated ? `Synced ${lastUpdated}` : "Just synced"}</span>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3 self-end md:self-center">
            <Link
              ...
              className="h-11 px-6 rounded-xl bg-[#0f172a] text-white text-[13px] font-bold shadow-lg shadow-slate-200 hover:shadow-xl hover:-translate-y-0.5 transition-all flex items-center gap-2 group"
            >
              <Search className="h-4 w-4 text-teal-400 group-hover:scale-110 transition-transform" />
              Find Opportunities
            </Link>
            <Link
              href="/freelancer/profile"
              className="h-11 px-5 rounded-xl border border-gray-200 bg-white text-[#0f172a] text-[13px] font-bold hover:bg-gray-50 transition-all flex items-center gap-2"
            >
                ...
                <div key={c.id} className="flex gap-3 py-3.5">
                  ...
                  <div className="flex flex-col items-end gap-1">
                    <span className="font-mono text-sm font-bold text-[#0f172a]">
                      {c.minBudget !== undefined && c.maxBudget !== undefined && c.minBudget !== null && c.maxBudget !== null && c.minBudget !== c.maxBudget
                        ? `₹${c.minBudget.toLocaleString("en-IN")} — ₹${c.maxBudget.toLocaleString("en-IN")}`

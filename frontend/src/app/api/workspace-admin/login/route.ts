...
export async function POST(req: NextRequest) {
  ...
  console.log("[workspace-admin/debug]", { 
    inputEmail: normalized, 
    storedEmail: adminEmail, 
    emailMatch: normalized === adminEmail,
    hashPresent: !!hash,
  ...
  console.log("[workspace-admin/debug] results:", { validEmail, validPass })

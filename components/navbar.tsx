          ...
          <div className="flex shrink-0 items-center justify-end gap-2 sm:gap-3">
            ...
            <Link href="/auth/signin">
              <Button
                variant="outline"
                className={cn(
                  "hidden sm:inline-flex rounded-lg px-4 py-2 text-sm font-semibold shadow-none transition-all duration-300",
                  scrolled
                    ? "border-[var(--primary)] bg-transparent text-[var(--primary)] hover:bg-[var(--primary-light)]"

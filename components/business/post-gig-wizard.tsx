...
export function PostGigWizardPage() {
  ...
  async function submit(isDraft: boolean) {
    ...
    try {
      ...
      if (isDraft) {
        ...
        toast.success("Your gig is live! Freelancers can now apply.")
        router.push("/business/my-gigs")
      }
    } catch {
    ...
    <div className="mx-auto max-w-6xl pb-24">
      <div className="mb-6 flex flex-wrap items-center justify-between gap-4">
        <div>
          ...
          <h1 className="text-2xl font-bold text-[#0f172a]">Post a new gig</h1>

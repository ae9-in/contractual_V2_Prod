...
function ApplicantCard({
  ...
  const rate = a.proposedPrice != null ? formatCurrency(a.proposedPrice) : "—"
      ...
      <div className="flex flex-col xl:flex-row xl:gap-8">
        <div className="flex-1">
          ...
          <div className="flex gap-4 items-start">
            {f.image ? (
              <img src={f.image} alt={f.name} className="h-14 w-14 shrink-0 rounded-full object-cover shadow-sm" />
            ) : (

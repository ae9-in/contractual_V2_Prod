...
export function HeroSection() {
  ...
  return (
    <section className="relative overflow-hidden bg-[var(--dark-surface)] pb-12 pt-[72px] lg:pb-20">
      <div className="container-page section-y !pt-8">
        ...
        <div className="relative min-h-[min(56svh,480px)] overflow-hidden rounded-[28px] shadow-[0_24px_80px_rgba(0,0,0,0.35)] lg:min-h-[min(72svh,640px)]">
          ...
          <div className="relative z-10 flex min-h-[min(56svh,480px)] flex-col gap-8 p-6 md:p-10 lg:min-h-[min(72svh,640px)] lg:flex-row lg:items-stretch lg:justify-between lg:gap-10 lg:p-12">
            ...
            <div className="flex max-w-2xl flex-col justify-center space-y-6">
              <div className="inline-flex w-fit rounded-full border border-white/15 bg-white/10 px-4 py-2 text-xs font-semibold uppercase tracking-wider text-white/90 backdrop-blur-md">
                Trusted by teams in 40+ countries
              </div>
              <h1 className="font-display text-4xl leading-[1.08] text-white md:text-5xl lg:text-[2.85rem]">
                Connecting businesses in need to{" "}
                <span className="bg-gradient-to-r from-[#a8e0e3] via-white to-[#c8f0f0] bg-clip-text text-transparent">
            ...
            <div className="relative hidden w-full max-w-[340px] flex-shrink-0 lg:block">
              ...
              >
                <div className="mb-4 flex items-center gap-2">
                  <span className="flex h-9 w-9 items-center justify-center rounded-xl bg-[var(--primary-light)] text-[var(--primary-dark)]">
                    <Briefcase className="h-5 w-5" />
                  </span>
                  <h2 className="text-base font-bold text-[var(--text-primary)]">Live opportunities</h2>
                </div>
        ...
        {/* Featured photography strip — graded tiles */}
        <div className="mt-10 grid grid-cols-2 gap-3 md:grid-cols-4 lg:gap-4">
          {FEATURE_STRIP.map((item, i) => (
            <motion.div
              ...
              className="group relative aspect-[5/3] overflow-hidden rounded-2xl border border-[var(--border)] shadow-md"
            >
              <Image
                src={item.src}
                alt={item.label}
              ...
              />
              <div className="absolute inset-0 bg-gradient-to-t from-[#1a1a2e]/85 via-[#2d7a7e]/25 to-transparent" />
              <div className="absolute inset-0 bg-gradient-to-br from-[var(--primary)]/30 to-transparent mix-blend-soft-light" />
              <p className="absolute bottom-3 left-3 text-sm font-bold text-white drop-shadow-md">
                {item.label}
              </p>
            </motion.div>
          ))}

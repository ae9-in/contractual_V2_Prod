...
export function LandingNavbar() {
  ...
  return (
    ...
    >
      <div className="mx-auto flex h-[72px] max-w-[1280px] items-center justify-between gap-4 px-4 lg:px-6">
        {/* Logo */}
        ...
        <div className="flex items-center justify-end gap-2 sm:gap-3">
          ...
          <button
            type="button"
            className="relative hidden rounded-full p-2.5 text-white/80 transition-colors hover:bg-white/10 hover:text-white sm:flex"
            aria-label="Notifications"
          >
            <Bell className="h-5 w-5" />
            <span className="absolute right-1.5 top-1.5 h-2 w-2 rounded-full bg-red-500 ring-2 ring-[var(--dark-surface)]" />
          </button>

          <button
            type="button"
            className="hidden items-center gap-1 rounded-full sm:flex"
            aria-label="Account menu"
          >
            <Avatar className="h-9 w-9 border border-white/20">
              <AvatarFallback className="bg-[var(--gradient-primary)] text-xs font-bold text-white">
                CJ
              </AvatarFallback>
            </Avatar>
          </button>
          ...
          <Link
            href="/auth/signin"
            className="hidden items-center gap-2 rounded-full bg-neutral-950 px-4 py-2.5 text-sm font-semibold text-white shadow-lg transition-transform hover:scale-[1.02] sm:inline-flex"
          >
      ...
      >
        <div className="space-y-1 px-4 py-4">
          ...
          <div className="mt-4 flex flex-col gap-2 border-t border-white/10 pt-4">
            <Link
              href="/auth/signin"
              className="flex items-center justify-center gap-2 rounded-full bg-neutral-950 py-3 text-sm font-semibold text-white"
            >
              <AppleIcon className="h-4 w-4" /> Sign in
            </Link>
